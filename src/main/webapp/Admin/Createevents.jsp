                    ...
                    <div class="card  border-warning">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-groub">
                                        <label for="viewid"> summary content</label>
                                        <input type="text" class="form-control border-warning" name="summaryContent"
                                            id="summaryContent" aria-describedby="content">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="card-footer text-mured">
                            <div class="offset-8 col-4 ">
                                <button formaction="/dam/Homeadmin/insertevents"
                                    class="btn btn-success rounded-pill border-warning">create</button>
                                <button formaction="/java4final/Createview/Update"
                                    class="btn btn-warning rounded-pill border-danger">update</button>
                                <button type="reset" class="btn btn-success rounded-pill border-light">clear</button>
                                <a href="/sof2041final/Homeadmin" class="btn btn-info rounded-pill border-light">exit</a>
                            </div>
                        </div>
                    </div>
                </form>
