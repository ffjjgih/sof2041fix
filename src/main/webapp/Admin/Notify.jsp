			...
			<div class="bg-dark">
              ...
              <tbody>
                <tr>
                  ...
                  <td>Nguyễn Văn A</td>
                  <td>0933333221</td>
                  <td>ngõ 2, đường trần đại nghĩa,hà nội</td>
                  <td><a href="Updatebooking.jsp"  class="btn btn-warning text-center rounded-pill" > sửa</a></td>
                  <td><a href="#" class="btn btn-danger text-center rounded-pill" > hủy</a></td>
                </tr>
                <tr>
                  <th scope="row">2</th>
                  <td>Jacob</td>
							...
							<tbody>
								<c:forEach items="${ listfood }" var="item">
									<tr>
										...
										<th>09345451232</th>
                    					<th>hà nội</th>
                    					<th>khoai tây chiên</th>
                    					<th>1</th>
                    					<th>10.000đ</th>
										<th><a
											href="/sof2041final/Managefood/edit?id=${item.foodid }"
											class="btn btn-success text-center rounded-pill">Thanh toán</a></th>
										<th><a
											href="/sof2041final/Managefood/delete?id=${item.foodid }"
											class="btn btn-danger text-center rounded-pill">hủy đơn</a></th>
									</tr>
								</c:forEach>
							</tbody>
						</table>
