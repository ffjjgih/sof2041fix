				...
				<div class="offcanvas offcanvas-end bg-light" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
					...
					<div class="offcanvas-body">
						<ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
							<li class="nav-item">
								<a class="nav-link" aria-current="page" href="/sof2041final/Homeadmin"> 
							...
							<div class="card  border-warning">
										...
										<div class="col-3">
											<div class="border p-3">
												<input type="file" class="custom-file-input" name='poster' id='poster'
													...
													<img src="${f.poster }" alt="" class="img-fluid">
											</div>
										</div>
										<div class="col-9">
								...
								<div class="card-footer text-mured">
									<div class="offset-9 col-4 ">
										<button formaction="/dam/Managefood/insert"
											class="btn btn-success rounded-pill border-warning">create</button>
										<button
											formaction="/dam/Managefood/update?id=${f.foodid }"
